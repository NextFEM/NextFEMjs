...
/*        ''' Get drawing entities in the loaded DXF serialized in JSON format
        ...
        '''*/
        return await this.nfrest('POST', '/op/import/dxfentities', buffer, null);}
...
/*        ''' Import DXF from bytes
        ...
        Returns:
            Boolean
        '''*/
        return sbool(await this.nfrest('POST', '/op/import/dxfstream', buffer, null));}
...
/*        ''' Assign name to an already defined section
    ...
    async renumberElements(initialID, step_) {
/*        ''' Renumber elements in the model
        ...
        '''*/
        return sbool(await this.nfrest('GET', '/op/mesh/renumber/elements/'+str(initialID)+'/'+str(step_)+'', null, null));}
...
/*        ''' Renumber elements in the model with spatial criteria, using element centroid
    ...
    async renumberNodes(initialID, step_) {
/*        ''' Renumber nodes in the model
        ...
        Returns:
            True if renumbering has been applied, false otherwise
        '''*/
        return sbool(await this.nfrest('GET', '/op/mesh/renumber/nodes/'+str(initialID)+'/'+str(step_)+'', null, null));}
...
/*        ''' Make the selected section a fiber section. Suitable only for OpenSees solver.
    ...
    async setFirePoint(loadcase, fireNode, targetTemp, gradientY=0, gradientZ=0, tempAtten=20, dontLoadUnder=50, normalize=false, cylindricalXY=false) {
/*        ''' Set the point of fire used to set temperatures of all the elements in the model
        ...
        '''*/
        return des(await this.nfrest('GET', '/load/firepoint/'+qt(loadcase)+'/'+qt(fireNode)+'/'+str(targetTemp)+'/'+str(gradientY)+'/'+str(gradientZ)+'/'+str(tempAtten)+'/'+str(dontLoadUnder)+'/'+str(normalize)+'/'+str(cylindricalXY)+'', null, null));}
